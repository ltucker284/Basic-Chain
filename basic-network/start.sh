...
echo Install chaincode on peer0 and instantiate chaincode on channel
...
echo Install chaincode on the rest of the peers
sh ./setup-scripts/installChaincode.sh